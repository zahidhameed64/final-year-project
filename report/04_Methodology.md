...
The primary data source for this study is the **"Global YouTube Statistics"** dataset, obtained from **Kaggle**. For those unfamiliar with the platform, Kaggle is the world's largest data science community and platform, currently owned by Google. It serves as a premier global repository where data scientists, researchers, and enterprises publish high-quality, peer-reviewed datasets and host machine learning competitions. Sourcing data from Kaggle ensures a level of standardization and reliability that is often missing from raw web-scraped data. The specific dataset chosen for this research aggregates public metrics for approximately 1,000 of the most subscribed YouTube channels as of 2023, providing a statistically significant snapshot of the elite tier of the Creator Economy.
